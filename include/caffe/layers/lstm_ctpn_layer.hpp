#ifndef CAFFE_LSTMCTPN_LAYER_HPP_
#define CAFFE_LSTMCTPN_LAYER_HPP_ 
#include <vector>
...
class LstmCTPNLayer : public Layer<Dtype> {
 public:
  explicit LstmCTPNLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
